...
`],encapsulation:2})}return o})();var Ct=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]],[["","progressIndicator",""]]],Ft=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]","[progressIndicator]"];function Ot(o,e){o&1&&(Uc(0,"div",2),lD(1,3),Wc());}var Pt=new M("mat-mdc-fab-default-options",{providedIn:"root",factory:()=>Q}),Q={color:"accent"},En=(()=>{class o extends K{_options=v(Pt,{optional:true});_isFab=true;extended=false;constructor(){super(),this._options=this._options||Q,this.color=this._options.color||Q.color;}static \u0275fac=function(n){return new(n||o)};static \u0275cmp=yE({type:o,selectors:[["button","mat-fab",""],["a","mat-fab",""],["button","matFab",""],["a","matFab",""]],hostAttrs:[1,"mdc-fab","mat-mdc-fab-base","mat-mdc-fab"],hostVars:4,hostBindings:function(n,a){n&2&&oh("mdc-fab--extended",a.extended)("mat-mdc-extended-fab",a.extended);},inputs:{extended:[2,"extended","extended",QF]},exportAs:["matButton","matAnchor"],features:[_p],ngContentSelectors:Ft,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,a){n&1&&(cD(Ct),jp(0,"span",0),lD(1),Uc(2,"span",1),lD(3,1),Wc(),lD(4,2),UE(5,Ot,2,0,"div",2),jp(6,"span",3)(7,"span",4)),n&2&&(oh("mdc-button__ripple",!a._isFab)("mdc-fab__ripple",a._isFab),Bv(5),WE(a.showProgress()?5:-1));},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
