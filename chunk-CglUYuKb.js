import {z as zt,i as ie,Y as Yi}from'./chunk-nAWTOx8A.js';import {E as En,B as Bt,y as yt,Y as Yt}from'./chunk-Ddf6_1Ts.js';import {$,C as Ce,B as Bi}from'./chunk-Dgghgf1Z.js';import {E as Et}from'./chunk-CuteD9fT.js';import {v as v$1}from'./chunk-BeqgtSVH.js';import {v,bc as xt,aA as oe,bd as Zh,be as Kh,bf as Jh,bg as Gr,aq as be,g as gE,bh as Ut,a as vi,F as FD,B as Bc,P as Pp,at as dh,U as Up,M as MI,aF as BE,j as jv,av as uh,_ as _I,b as Lp,aG as $E,bi as qF,t as Ve$1,ab as EE,Q as QF,a2 as GD,ac as M,a7 as Gp,a5 as lD,a6 as uD,al as mr,aM as z,bj as EI,x as ve,bk as Dh,I as ZF,bl as hv,aV as sD,b2 as aD,bm as th,O as Op,a4 as zp,ah as mo,W as WE,as as YD,ag as oD,q as qE,bn as JD,bb as BD,i as Cf,l as lh,z as zc}from'./main-RHR5WD4O.js';import'./chunk-OfbKwqpt.js';import {L,j as jn,X as Xe,x as xn,Q as Qt,B as Bn,b as an,F}from'./chunk-CTV0LG5R.js';import'./chunk-CJNeQoHK.js';var Te=["*"],De=(()=>{class a{labelPosition="after";static \u0275fac=function(t){return new(t||a)};static \u0275cmp=gE({type:a,selectors:[["div","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(t,i){t&2&&th("mdc-form-field--align-end",i.labelPosition==="before");},inputs:{labelPosition:"labelPosition"},ngContentSelectors:Te,decls:1,vars:0,template:function(t,i){t&1&&(sD(),aD(0));},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return a})();var Oe=(a,u)=>u.data.id;function je(a,u){if(a&1&&(vi(0,"div")(1,"a",15),FD(2),Bc(),FD(3),vi(4,"div",16),Pp(5,"img",17),Bc()()),a&2){let e=oD(2).$implicit,t=oD(2);jv(),Lp("href",e.data.url,Cf),jv(),lh(e.data.url),jv(),zc(" ",t.data(e)," "),jv(2),Lp("src",e.data.thumbnail,Cf);}}function Ve(a,u){if(a&1&&(vi(0,"div")(1,"a",15),FD(2),Bc(),vi(3,"div",16)(4,"video",18),Pp(5,"source",19),Bc()()()),a&2){let e=oD(2).$implicit;jv(),Lp("href",e.data.url,Cf),jv(),lh(e.data.url),jv(3),Lp("src",e.data.media.reddit_video.fallback_url);}}function Le(a,u){if(a&1&&(vi(0,"div"),BE(1,je,6,4,"div")(2,Ve,6,3,"div"),Bc()),a&2){let e=oD().$implicit,t=oD(2);jv(),$E((t.findImage()||t.findBoth())&&!e.data.is_video?1:(t.findVideo()||t.findBoth())&&e.data.is_video?2:-1);}}function Ue(a,u){if(a&1&&BE(0,Le,3,1,"div"),a&2){let e=u.$implicit;$E(e.data.thumbnail!=="default"&&e.data.thumbnail!=="self"?0:-1);}}function $e(a,u){if(a&1&&(vi(0,"div",11)(1,"div",12)(2,"div",13),FD(3,"The Results see below"),Bc()(),vi(4,"div",14),WE(5,Ue,1,1,null,null,Oe),YD(7,"async"),Bc()()),a&2){let e=oD();jv(5),qE(JD(7,0,e.results$));}}var St=(()=>{class a{constructor(){this.httpClient=v(xt),this.searchSubject$=new oe,this.results$=Zh([]),this.searchString="",this.searchMode="Both",this.showSearchContentFormControl=new L(this.searchMode);}ngOnInit(){this.results$=this.searchSubject$.pipe(Kh(300),Jh(),Gr(e=>this.queryAPI(e)));}queryAPI(e){return console.log("queryAPI",e),this.httpClient.get(`https://www.reddit.com/r/aww/search.json?q=${e}`).pipe(be(t=>t.data.children))}ngModelChange(e){console.log("input changed",e),this.searchSubject$.next(e);}findBoth(){return this.showSearchContentFormControl.value==="Both"}findVideo(){return this.showSearchContentFormControl.value==="Video"}findImage(){return this.showSearchContentFormControl.value==="Image"}data(e){console.log("data",e);}static{this.\u0275fac=function(t){return new(t||a)};}static{this.\u0275cmp=gE({type:a,selectors:[["app-material-examples-main"]],decls:22,vars:3,consts:[[1,"title-layout"],[1,"text-warning"],[1,"d-flex","align-items-center","flex-wrap"],[1,"d-flex","align-items-center","flex-wrap","search-field-style"],["matInput","","id","searchString",3,"ngModelChange","ngModel"],["color","primary","labelPosition","after",1,"align-radio-group",3,"formControl"],["value","Both"],["value","Image"],["value","Video"],[1,"align-trashcan"],["mat-fab","","color","primary",3,"click"],[1,"result-area"],[1,"result-area-title"],[1,"result-area-title-text"],[1,"d-flex","align-content-around","flex-wrap"],[2,"padding-left","20px",3,"href"],[2,"padding-left","20px"],["alt","data","width","auto","height","auto",3,"src"],["width","320","height","200","controls",""],[3,"src"]],template:function(t,i){t&1&&(vi(0,"div",0)(1,"div",1),FD(2,"It not belongs strictly the Material topic, but interesting, Simple wrap an API. for example Wrap https://www.reddit.com/r/aww/search.json?q="),Bc()(),Pp(3,"hr"),vi(4,"div",2)(5,"div",3)(6,"mat-form-field")(7,"mat-label"),FD(8,"Search on reddit.com"),Bc(),vi(9,"input",4),dh("ngModelChange",function(l){return BD(i.searchString,l)||(i.searchString=l),l}),Up("ngModelChange",function(l){return i.ngModelChange(l)}),Bc(),MI(),Bc(),vi(10,"mat-radio-group",5)(11,"mat-radio-button",6),FD(12,"Both"),Bc(),vi(13,"mat-radio-button",7),FD(14,"Image"),Bc(),vi(15,"mat-radio-button",8),FD(16,"Video"),Bc()(),MI(),Bc(),vi(17,"div",9)(18,"button",10),Up("click",function(){return i.searchString="",i.showSearchContentFormControl.setValue("Both"),i.searchSubject$.next("")}),vi(19,"mat-icon"),FD(20,"delete"),Bc()()()(),BE(21,$e,8,2,"div",11)),t&2&&(jv(9),uh("ngModel",i.searchString),_I(),jv(),Lp("formControl",i.showSearchContentFormControl),_I(),jv(11),$E(i.searchString?21:-1));},dependencies:[zt,ie,Yi,jn,Xe,xn,Qt,A,Bn,an,B,En,Et,Ut],styles:[".title-layout[_ngcontent-%COMP%]{display:flex;flex-direction:row;justify-content:center;font-size:large}.result-area[_ngcontent-%COMP%]{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:20px;border:1px solid #0cdfaa;border-radius:15px;height:100%;padding:.5rem}.result-area-title[_ngcontent-%COMP%]{margin:10px}.result-area-title-text[_ngcontent-%COMP%]{font-size:large;font-weight:700}.search-field-style[_ngcontent-%COMP%]{width:29rem;padding-top:.5rem}.align-radio-group[_ngcontent-%COMP%]{margin-top:-18px}.align-trashcan[_ngcontent-%COMP%]{margin-top:-10px}"],changeDetection:1});}}return a})();
