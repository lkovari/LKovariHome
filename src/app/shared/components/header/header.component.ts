...
export class HeaderComponent {
  ...
  lastUpdateDate = new Date('08/15/2026 00:56 AM');
  lastUpdateTooltip = 'Angular 22: standalone, Vitest, FormValueControl/FormCheckboxControl custom widgets, Add Labyrinth, Add Mersenne, Improve Mersenne, Update CV. Add knowledge base, Learning check, fix fake question length, md instead of pdf of knowledge base, md to firestore';
}
