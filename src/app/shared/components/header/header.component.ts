...
export class HeaderComponent {
  ...
  lastUpdateDate = new Date('08/14/2026 11:30 PM');
  lastUpdateTooltip = 'Angular 22: standalone, Vitest, FormValueControl/FormCheckboxControl custom widgets, Add Labyrinth, Add Mersenne, Improve Mersenne, Update CV. Add knowledge base, Learning check, fix fake question length, md instead of pdf of knowledge base';
}
