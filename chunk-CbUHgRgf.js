...
`],encapsulation:2})}return e})();var Ot=["*",[["","progressIndicator",""]]],Pt=["*","[progressIndicator]"];function Bt(e,a){e&1&&(zc(0,"div",1),yD(1,1),Qc());}var Nt=new M("MAT_BUTTON_CONFIG");function Et(e){return e==null?void 0:i0(e)}var Z=(()=>{class e{_elementRef=v(Dr);_ngZone=v(Q$1);_animationsDisabled=Bi();_config=v(Nt,{optional:true});_focusMonitor=v(Ce);_cleanupClick;_renderer=v(SI);_rippleLoader=v(_t);_isAnchor;_isFab=false;color;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=t,this._updateRippleDisabled();}_disableRipple=false;get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._updateRippleDisabled();}_disabled=false;ariaDisabled;disabledInteractive;tabIndex;set _tabindex(t){this.tabIndex=t;}showProgress=YF(false,{transform:o0});constructor(){v(v$1).load(wt);let t=this._elementRef.nativeElement;this._isAnchor=t.tagName==="A",this.disabledInteractive=this._config?.disabledInteractive??false,this.color=this._config?.color??null,this._rippleLoader?.configureRipple(t,{className:"mat-mdc-button-ripple"});}ngAfterViewInit(){this._focusMonitor.monitor(this._elementRef,true),this._isAnchor&&this._setupAsAnchor();}ngOnDestroy(){this._cleanupClick?.(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement);}focus(t="program",n){t?this._focusMonitor.focusVia(this._elementRef.nativeElement,t,n):this._elementRef.nativeElement.focus(n);}_getAriaDisabled(){return this.ariaDisabled!=null?this.ariaDisabled:this._isAnchor?this.disabled||null:this.disabled&&this.disabledInteractive?true:null}_getDisabledAttribute(){return this.disabledInteractive||!this.disabled?null:true}_updateRippleDisabled(){this._rippleLoader?.setDisabled(this._elementRef.nativeElement,this.disableRipple||this.disabled);}_getTabIndex(){return this._isAnchor?this.disabled&&!this.disabledInteractive?-1:this.tabIndex:this.tabIndex}_setupAsAnchor(){this._cleanupClick=this._ngZone.runOutsideAngular(()=>this._renderer.listen(this._elementRef.nativeElement,"click",t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation());}));}static \u0275fac=function(n){return new(n||e)};static \u0275dir=SE({type:e,hostAttrs:[1,"mat-mdc-button-base"],hostVars:15,hostBindings:function(n,o){n&2&&(Vp("disabled",o._getDisabledAttribute())("aria-disabled",o._getAriaDisabled())("tabindex",o._getTabIndex()),FD(o.color?"mat-"+o.color:""),ch("mat-mdc-button-progress-indicator-shown",o.showProgress())("mat-mdc-button-disabled",o.disabled)("mat-mdc-button-disabled-interactive",o.disabledInteractive)("mat-unthemed",!o.color)("_mat-animation-noopable",o._animationsDisabled));},inputs:{color:"color",disableRipple:[2,"disableRipple","disableRipple",o0],disabled:[2,"disabled","disabled",o0],ariaDisabled:[2,"aria-disabled","ariaDisabled",o0],disabledInteractive:[2,"disabledInteractive","disabledInteractive",o0],tabIndex:[2,"tabIndex","tabIndex",Et],_tabindex:[2,"tabindex","_tabindex",Et],showProgress:[1,"showProgress"]}})}return e})(),St=(()=>{class e extends Z{constructor(){super(),this._rippleLoader.configureRipple(this._elementRef.nativeElement,{centered:true});}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=wE({type:e,selectors:[["button","mat-icon-button",""],["a","mat-icon-button",""],["button","matIconButton",""],["a","matIconButton",""]],hostAttrs:[1,"mdc-icon-button","mat-mdc-icon-button"],exportAs:["matButton","matAnchor"],features:[Rp],ngContentSelectors:Pt,decls:5,vars:1,consts:[[1,"mat-mdc-button-persistent-ripple","mdc-icon-button__ripple"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(mD(Ot),$p(0,"span",0),yD(1),YE(2,Bt,2,0,"div",1),$p(3,"span",2)(4,"span",3)),n&2&&(zv(2),KE(o.showProgress()?2:-1));},styles:[`.mat-mdc-icon-button {
...
`],encapsulation:2})}return e})();var kt=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=ME({type:e});static \u0275inj=nu({imports:[I]})}return e})();var It=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]],[["","progressIndicator",""]]],Mt=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]","[progressIndicator]"];function Lt(e,a){e&1&&(zc(0,"div",2),yD(1,3),Qc());}function jt(e,a){e&1&&(zc(0,"div",2),yD(1,3),Qc());}var Dt=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),Tn=(()=>{class e extends Z{get appearance(){return this._appearance}set appearance(t){this.setAppearance(t||this._config?.defaultAppearance||"text");}_appearance=null;constructor(){super();let t=Ut(this._elementRef.nativeElement);t&&this.setAppearance(t);}setAppearance(t){if(t===this._appearance)return;let n=this._elementRef.nativeElement.classList,o=this._appearance?Dt.get(this._appearance):null,r=Dt.get(t);o&&n.remove(...o),n.add(...r),this._appearance=t;}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=wE({type:e,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[Rp],ngContentSelectors:Mt,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(mD(It),$p(0,"span",0),yD(1),zc(2,"span",1),yD(3,1),Qc(),yD(4,2),YE(5,Lt,2,0,"div",2),$p(6,"span",3)(7,"span",4)),n&2&&(ch("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab),zv(5),KE(o.showProgress()?5:-1));},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2})}return e})();function Ut(e){return e.hasAttribute("mat-raised-button")?"elevated":e.hasAttribute("mat-stroked-button")?"outlined":e.hasAttribute("mat-flat-button")?"filled":e.hasAttribute("mat-button")?"text":null}var Ht=new M("mat-mdc-fab-default-options",{providedIn:"root",factory:()=>tt}),tt={color:"accent"},Cn=(()=>{class e extends Z{_options=v(Ht,{optional:true});_isFab=true;extended=false;constructor(){super(),this._options=this._options||tt,this.color=this._options.color||tt.color;}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=wE({type:e,selectors:[["button","mat-fab",""],["a","mat-fab",""],["button","matFab",""],["a","matFab",""]],hostAttrs:[1,"mdc-fab","mat-mdc-fab-base","mat-mdc-fab"],hostVars:4,hostBindings:function(n,o){n&2&&ch("mdc-fab--extended",o.extended)("mat-mdc-extended-fab",o.extended);},inputs:{extended:[2,"extended","extended",o0]},exportAs:["matButton","matAnchor"],features:[Rp],ngContentSelectors:Mt,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(mD(It),$p(0,"span",0),yD(1),zc(2,"span",1),yD(3,1),Qc(),yD(4,2),YE(5,jt,2,0,"div",2),$p(6,"span",3)(7,"span",4)),n&2&&(ch("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab),zv(5),KE(o.showProgress()?5:-1));},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
...
`],encapsulation:2})}return e})();var Fn=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=ME({type:e});static \u0275inj=nu({imports:[kt,I]})}return e})();export{Cn as C,Fn as F,K,St as S,Tn as T,Wt as W,wt as w,z};