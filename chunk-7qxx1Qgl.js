import {v as v$1,a2 as Ee,bM as ce,bJ as Mr,bR as s0,bI as Wt,w as wE}from'./main-YZ26ISTO.js';var i=new WeakMap,v=(()=>{class e{_appRef;_injector=v$1(Ee);_environmentInjector=v$1(ce);load(o){let n=this._appRef=this._appRef||this._injector.get(Mr),t=i.get(n);t||(t={loaders:new Set,refs:[]},i.set(n,t),n.onDestroy(()=>{i.get(n)?.refs.forEach(m=>m.destroy()),i.delete(n);})),t.loaders.has(o)||(t.loaders.add(o),t.refs.push(s0(o,{environmentInjector:this._environmentInjector})));}static \u0275fac=function(n){return new(n||e)};static \u0275prov=Wt({token:e,factory:e.\u0275fac})}return e})();var H=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275cmp=wE({type:e,selectors:[["ng-component"]],exportAs:["cdkVisuallyHidden"],decls:0,vars:0,template:function(n,t){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
