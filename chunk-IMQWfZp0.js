import {A as Ae,f,j,K as K$1,W as W$1}from'./chunk-Bp7iJgZ0.js';import {v as v$1}from'./chunk-LSEG3cqg.js';import {c}from'./chunk-CBDuy06q.js';import {W as NE,Y as nu,ax as I,b as bE,a6 as kp,bE as yD,U as Up,bF as vD,z as zc,g as Qc,h as KE,l as lh,a as Qv,J as JE,v,a7 as i0,ay as Dr,aW as Q$1,bB as R$1,bA as xI,f as KF,ao as xE,H as Hp,af as jD,cA as l,a5 as Ee,a2 as D,ap as M,aJ as Bo,cG as mr,bG as Wt$1,a8 as s0}from'./main-7YEBPUYV.js';var d=(function(e){return e[e.FADING_IN=0]="FADING_IN",e[e.VISIBLE=1]="VISIBLE",e[e.FADING_OUT=2]="FADING_OUT",e[e.HIDDEN=3]="HIDDEN",e})(d||{}),X=class{_renderer;element;config;_animationForciblyDisabledThroughCss;state=d.HIDDEN;constructor(a,t,n,o=false){this._renderer=a,this.element=t,this.config=n,this._animationForciblyDisabledThroughCss=o;}fadeOut(){this._renderer.fadeOutRipple(this);}},vt=W$1({passive:true,capture:true}),J=class{_events=new Map;addHandler(a,t,n,o){let r=this._events.get(t);if(r){let l=r.get(n);l?l.add(o):r.set(n,new Set([o]));}else this._events.set(t,new Map([[n,new Set([o])]])),a.runOutsideAngular(()=>{document.addEventListener(t,this._delegateEventHandler,vt);});}removeHandler(a,t,n){let o=this._events.get(a);if(!o)return;let r=o.get(t);r&&(r.delete(n),r.size===0&&o.delete(t),o.size===0&&(this._events.delete(a),document.removeEventListener(a,this._delegateEventHandler,vt)));}_delegateEventHandler=a=>{let t=f(a);t&&this._events.get(a.type)?.forEach((n,o)=>{(o===t||o.contains(t))&&n.forEach(r=>r.handleEvent(a));});}},R={enterDuration:225,exitDuration:150},Rt=800,ht=W$1({passive:true,capture:true}),gt=["mousedown","touchstart"],yt=["mouseup","mouseleave","touchend","touchcancel"],zt=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275cmp=bE({type:e,selectors:[["ng-component"]],hostAttrs:["mat-ripple-style-loader",""],decls:0,vars:0,template:function(n,o){},styles:[`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`],encapsulation:2})}return e})();var Ot=["*",[["","progressIndicator",""]]],Pt=["*","[progressIndicator]"];function Bt(e,a){e&1&&(zc(0,"div",1),vD(1,1),Qc());}var Nt=new M("MAT_BUTTON_CONFIG");function Et(e){return e==null?void 0:s0(e)}var Z=(()=>{class e{_elementRef=v(Dr);_ngZone=v(Q$1);_animationsDisabled=R$1();_config=v(Nt,{optional:true});_focusMonitor=v(Ae);_cleanupClick;_renderer=v(xI);_rippleLoader=v(_t);_isAnchor;_isFab=false;color;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=t,this._updateRippleDisabled();}_disableRipple=false;get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._updateRippleDisabled();}_disabled=false;ariaDisabled;disabledInteractive;tabIndex;set _tabindex(t){this.tabIndex=t;}showProgress=KF(false,{transform:i0});constructor(){v(v$1).load(wt);let t=this._elementRef.nativeElement;this._isAnchor=t.tagName==="A",this.disabledInteractive=this._config?.disabledInteractive??false,this.color=this._config?.color??null,this._rippleLoader?.configureRipple(t,{className:"mat-mdc-button-ripple"});}ngAfterViewInit(){this._focusMonitor.monitor(this._elementRef,true),this._isAnchor&&this._setupAsAnchor();}ngOnDestroy(){this._cleanupClick?.(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement);}focus(t="program",n){t?this._focusMonitor.focusVia(this._elementRef.nativeElement,t,n):this._elementRef.nativeElement.focus(n);}_getAriaDisabled(){return this.ariaDisabled!=null?this.ariaDisabled:this._isAnchor?this.disabled||null:this.disabled&&this.disabledInteractive?true:null}_getDisabledAttribute(){return this.disabledInteractive||!this.disabled?null:true}_updateRippleDisabled(){this._rippleLoader?.setDisabled(this._elementRef.nativeElement,this.disableRipple||this.disabled);}_getTabIndex(){return this._isAnchor?this.disabled&&!this.disabledInteractive?-1:this.tabIndex:this.tabIndex}_setupAsAnchor(){this._cleanupClick=this._ngZone.runOutsideAngular(()=>this._renderer.listen(this._elementRef.nativeElement,"click",t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation());}));}static \u0275fac=function(n){return new(n||e)};static \u0275dir=xE({type:e,hostAttrs:[1,"mat-mdc-button-base"],hostVars:15,hostBindings:function(n,o){n&2&&(Hp("disabled",o._getDisabledAttribute())("aria-disabled",o._getAriaDisabled())("tabindex",o._getTabIndex()),jD(o.color?"mat-"+o.color:""),lh("mat-mdc-button-progress-indicator-shown",o.showProgress())("mat-mdc-button-disabled",o.disabled)("mat-mdc-button-disabled-interactive",o.disabledInteractive)("mat-unthemed",!o.color)("_mat-animation-noopable",o._animationsDisabled));},inputs:{color:"color",disableRipple:[2,"disableRipple","disableRipple",i0],disabled:[2,"disabled","disabled",i0],ariaDisabled:[2,"aria-disabled","ariaDisabled",i0],disabledInteractive:[2,"disabledInteractive","disabledInteractive",i0],tabIndex:[2,"tabIndex","tabIndex",Et],_tabindex:[2,"tabindex","_tabindex",Et],showProgress:[1,"showProgress"]}})}return e})(),St=(()=>{class e extends Z{constructor(){super(),this._rippleLoader.configureRipple(this._elementRef.nativeElement,{centered:true});}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=bE({type:e,selectors:[["button","mat-icon-button",""],["a","mat-icon-button",""],["button","matIconButton",""],["a","matIconButton",""]],hostAttrs:[1,"mdc-icon-button","mat-mdc-icon-button"],exportAs:["matButton","matAnchor"],features:[kp],ngContentSelectors:Pt,decls:5,vars:1,consts:[[1,"mat-mdc-button-persistent-ripple","mdc-icon-button__ripple"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(yD(Ot),Up(0,"span",0),vD(1),KE(2,Bt,2,0,"div",1),Up(3,"span",2)(4,"span",3)),n&2&&(Qv(2),JE(o.showProgress()?2:-1));},styles:[`.mat-mdc-icon-button {
...
`],encapsulation:2})}return e})();var kt=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=NE({type:e});static \u0275inj=nu({imports:[I]})}return e})();var It=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]],[["","progressIndicator",""]]],Mt=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]","[progressIndicator]"];function Lt(e,a){e&1&&(zc(0,"div",2),vD(1,3),Qc());}function jt(e,a){e&1&&(zc(0,"div",2),vD(1,3),Qc());}var Dt=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),Tn=(()=>{class e extends Z{get appearance(){return this._appearance}set appearance(t){this.setAppearance(t||this._config?.defaultAppearance||"text");}_appearance=null;constructor(){super();let t=Ut(this._elementRef.nativeElement);t&&this.setAppearance(t);}setAppearance(t){if(t===this._appearance)return;let n=this._elementRef.nativeElement.classList,o=this._appearance?Dt.get(this._appearance):null,r=Dt.get(t);o&&n.remove(...o),n.add(...r),this._appearance=t;}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=bE({type:e,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[kp],ngContentSelectors:Mt,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(yD(It),Up(0,"span",0),vD(1),zc(2,"span",1),vD(3,1),Qc(),vD(4,2),KE(5,Lt,2,0,"div",2),Up(6,"span",3)(7,"span",4)),n&2&&(lh("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab),Qv(5),JE(o.showProgress()?5:-1));},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2})}return e})();function Ut(e){return e.hasAttribute("mat-raised-button")?"elevated":e.hasAttribute("mat-stroked-button")?"outlined":e.hasAttribute("mat-flat-button")?"filled":e.hasAttribute("mat-button")?"text":null}var Ht=new M("mat-mdc-fab-default-options",{providedIn:"root",factory:()=>tt}),tt={color:"accent"},Cn=(()=>{class e extends Z{_options=v(Ht,{optional:true});_isFab=true;extended=false;constructor(){super(),this._options=this._options||tt,this.color=this._options.color||tt.color;}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=bE({type:e,selectors:[["button","mat-fab",""],["a","mat-fab",""],["button","matFab",""],["a","matFab",""]],hostAttrs:[1,"mdc-fab","mat-mdc-fab-base","mat-mdc-fab"],hostVars:4,hostBindings:function(n,o){n&2&&lh("mdc-fab--extended",o.extended)("mat-mdc-extended-fab",o.extended);},inputs:{extended:[2,"extended","extended",i0]},exportAs:["matButton","matAnchor"],features:[kp],ngContentSelectors:Mt,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,o){n&1&&(yD(It),Up(0,"span",0),vD(1),zc(2,"span",1),vD(3,1),Qc(),vD(4,2),KE(5,jt,2,0,"div",2),Up(6,"span",3)(7,"span",4)),n&2&&(lh("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab),Qv(5),JE(o.showProgress()?5:-1));},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
...
`],encapsulation:2})}return e})();var Fn=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=NE({type:e});static \u0275inj=nu({imports:[kt,I]})}return e})();export{Cn as C,Fn as F,K,St as S,Tn as T,Wt as W,wt as w,z};